    ...
    return (
        <div className="min-h-screen px-3 py-4 sm:p-6">
            <div className="mx-auto max-w-6xl">
                {/* Header */}
                <div className="mb-8">
                    <h1 className="mb-2 text-2xl font-bold text-white sm:text-3xl">Squad</h1>
                    <p className="text-sm text-slate-400 sm:text-base">Connect with fellow Python learners and grow together</p>
                </div>
                ...
                <div className="rounded-2xl border border-white/10 bg-white/5 p-4 sm:p-6">
                    ...
                    {activeTab === "chat" && (
                        <div>
                            <h2 className="mb-4 text-xl font-bold text-white sm:text-2xl">Squad Chat</h2>
