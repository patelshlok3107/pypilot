            ...
            <Card key={track.slug} className={track.slug === selectedTrack ? "border-brand-300/40" : ""}>
              <div className="flex flex-wrap items-start justify-between gap-3">
                ...
                <div className="flex w-full flex-col gap-2 sm:w-auto sm:flex-row">
                  <Button className="w-full sm:w-auto" variant="ghost" onClick={() => setSelectedTrack(track.slug)}>
                    View
                  </Button>
                  <Button
          ...
          <Card>
            ...
            {selectedTrackLocked ? (
              ...
              <>
                ...
                <Button className="mt-3 w-full sm:w-auto" variant="secondary" onClick={generateCertificate} disabled={!selectedTrack}>
