...
export function OfflineAITutorChat() {
  ...
  const [isSignedIn, setIsSignedIn] = useState<boolean>(Boolean(getToken()));
  ...
  const sendMessage = async () => {
    ...
    try {
      ...
      // Call API (include Authorization if available)
      ...
      <div className="mb-6">
        ...
        <div className="flex gap-2 items-center">
          ...
          <div className="ml-auto flex items-center gap-2">
            ...
            <span className="text-sm font-medium text-slate-700">{getToken() ? "Yes" : "No"}</span>
            {!getToken() && (
              <Button
