...
export function ChatInterface() {
    ...
    return (
        <div className="flex h-full flex-col rounded-2xl border border-white/5 bg-white/5 overflow-hidden">
            {/* Chat Header */}
                ...
                {messages.length === 0 ? (
                    ...
                    messages.map((msg) => (
                        <div key={msg.id} className={`flex ${msg.isMe ? "justify-end" : "justify-start"}`}>
                            <div className={`flex max-w-[80%] gap-3 ${msg.isMe ? "flex-row-reverse" : "flex-row"}`}>
