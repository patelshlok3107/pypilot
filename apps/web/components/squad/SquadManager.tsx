        ...
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                ...
                <button
                    ...
                    className="flex items-center gap-2 rounded-lg bg-gradient-to-r from-purple-500 to-pink-600 px-4 py-2 font-bold text-white hover:from-purple-600 hover:to-pink-700"
                >
                    <Plus size={16} />
                    Create Squad
                </button>
                        ...
                        >
                            ...
                            <div className="flex items-center justify-between">
                                ...
                                <div className="flex gap-2">
                                    <button className="rounded-lg bg-blue-500 px-3 py-1 text-xs font-bold text-white hover:bg-blue-600">
                                    ...
                                    {squad.role !== "owner" && (
                                        <button
                                            ...
                                            className="rounded-lg bg-white/5 px-3 py-1 text-xs font-bold text-slate-400 hover:bg-red-500 hover:text-white"
                                        >
                                            Leave
                                        </button>
                                    )}
