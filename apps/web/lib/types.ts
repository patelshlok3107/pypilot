...
export type DashboardStats = {
  ...
  earned_advanced_access: boolean;
  can_access_advanced_topics: boolean;
  advanced_unlock_xp_required: number;
  advanced_unlock_lessons_required: number;
};
...
export type UserEntitlements = {
  ...
  has_earned_premium_access: boolean;
